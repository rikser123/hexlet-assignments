...
class AppTest {
    ...
    public void testReversedSequence() {
       var str = "avrast";
       var reversedStr = "tsarva";
       var reversed = new ReversedSequence(str);

       assertThat(reversed.toString()).isEqualTo(reversedStr);

       var subSequence = reversed.subSequence(0, 2);
       assertThat(subSequence.toString()).isEqualTo("st");
    }
